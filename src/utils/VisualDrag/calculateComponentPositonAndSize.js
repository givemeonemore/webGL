...
const funcs = {
  lt: calculateLeftTop, // 左顶点与上边线的间距
  t: calculateTop, // 上边距
  rt: calculateRightTop, // 右顶点与上边线的间距
  r: calculateRight, // 右边距
  rb: calculateRightBottom, // 右顶点与下边线的间距
  b: calculateBottom, // 下边距
  lb: calculateLeftBottom, // 左顶点与下边线的间距
  l: calculateLeft // 左边距
};
